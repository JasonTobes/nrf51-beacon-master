...
#define DEVICE_NAME                     "Falcon Beacon"                             /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "Nordic"                      /**< Manufacturer. Will be passed to Device Information Service. */

//#define DEVICE_CONNECTED_LED            BSP_BOARD_LED_1
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
    ...
    switch (ble_adv_evt)
    {
        ...
        case BLE_ADV_EVT_SLOW_WHITELIST:
            ...
            err_code = bsp_indication_set(BSP_INDICATE_ADVERTISING_WHITELIST);
            APP_ERROR_CHECK(err_code);
            //TODO err_code = ble_advertising_restart_without_whitelist();
            err_code = ble_advertising_start(BLE_ADV_MODE_FAST);
            APP_ERROR_CHECK(err_code);
            break;
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
           ...
           // bsp_board_led_on(DEVICE_CONNECTED_LED);
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            //bsp_board_led_off(DEVICE_CONNECTED_LED);
